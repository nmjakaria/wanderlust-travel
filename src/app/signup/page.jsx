    ...
    return (
        <div className="max-w-7xl mx-auto mt-10 mb-10">
            <div className="text-center mb-4">
                ...
                <p className="text-lg text-gray-700">Start your adventure with Wanderlust</p>
            </div>
            <Card className="w-full max-w-md border rounded-md mx-auto">
                ...
                <h3 className="text-center text-lg font-bold">Already have an account? <span className="text-cyan-800"><Link href={'/login'}>Sign In</Link></span></h3>
            </Card>
        </div>
    );
};
